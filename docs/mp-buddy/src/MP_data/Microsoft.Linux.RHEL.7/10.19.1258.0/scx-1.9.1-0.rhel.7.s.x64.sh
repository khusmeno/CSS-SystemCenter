...
TAR_FILE=scx-1.9.1-0.universal.s.x64.tar
OM_PKG=scx-1.9.1-0.universal.s.x64
OMI_PKG=omi-1.9.1-0.ulinux.s.x64
PROVIDER_ONLY=0

SCRIPT_LEN=708
SCRIPT_LEN_PLUS_ONE=709
...
ulinux_detect_openssl_version() {
    ...
    if [ $OPENSSL_SYSTEM_VERSION_100 = 0 ]; then
        ...
        TMPBINDIR=110
    elif [ $OPENSSL_SYSTEM_VERSION_300 = 0 ]; then
        TMPBINDIR=300
    else
