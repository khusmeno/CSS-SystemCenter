...
TAR_FILE=omsagent-1.19.0-0.universal.x64.tar
OMS_PKG=omsagent-1.19.0-0.universal.x64
DSC_PKG=omsconfig-1.3.0-0.x64
OMI_PKG=omi-1.8.1-0.ulinux.s.x64
SCX_PKG=scx-1.8.1-0.universal.s.x64
INSTALL_TYPE=
SCRIPT_LEN=1713
SCRIPT_LEN_PLUS_ONE=1714
...
{
    cat <<EOF
superproject: 86f2a652f2b75b096f471313add4fc89823ca8e4
auoms-kits: 38d2ee2a906d3dd3c6454c79be5bbd44f26ac1d0
dsc: 9bdbf0df2b2176b2b44d44e9f4bd6b06f23593bb
omi: 170d37552ba858deddf9d6095ebf39cdc140274b
omi-kits: 51dc3ae35550632ae73a64e4ee44ce06a6eadd5a
omsagent: e504d51182a61fe158913e5c9cbf70faadebc8e8
opsmgr-kits: 329545760488b3f919cd6a8dbae6d253e39bc33d
pal: 2fcc627c2830128d1a8864add2e3626d7d5a68c0
scxcore-kits: 2affad708244461771f8f773e0ceca863cdd20f2
EOF
}
